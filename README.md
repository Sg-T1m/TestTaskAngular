Очень не уверен в том, что правильно изобразил работу с апи, надеюсь пойдёт)) 
!Не обязательно выполнять все задания, выполните те, которые сделаете уверенно хорошо. Так же у поля имя нету специально валидации, чтобы изобразить ошибку по api. 
